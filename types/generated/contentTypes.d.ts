...
export interface ApiCartItemCartItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    addons_total_price: Schema.Attribute.Decimal &
    ...
    >;
    developer_amount: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    platform_commission: Schema.Attribute.Decimal &
      Schema.Attribute.DefaultTo<0>;
    ...
    selected_addons: Schema.Attribute.JSON;
    total_price: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    primaryProducts: Schema.Attribute.Relation<
      'oneToMany',
      'api::product.product'
    >;
...
export interface ApiChatChat extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    chat_messages: Schema.Attribute.Relation<
      ...
      'api::chat-message.chat-message'
    >;
    chat_meta: Schema.Attribute.JSON;
    chat_status: Schema.Attribute.Enumeration<['active', 'closed', 'blocked']> &
      Schema.Attribute.DefaultTo<'active'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiDeveloperProfileDeveloperProfile
  extends Struct.CollectionTypeSchema {
  collectionName: 'developer_profiles';
  info: {
    displayName: 'Developer Profile';
    pluralName: 'developer-profiles';
    singularName: 'developer-profile';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiDeveloperReviewDeveloperReview
  extends Struct.CollectionTypeSchema {
  collectionName: 'developer_reviews';
  info: {
    displayName: 'Developer Review';
    pluralName: 'developer-reviews';
    singularName: 'developer-review';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    developer: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    is_verified_purchase: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::developer-review.developer-review'
    > &
      Schema.Attribute.Private;
    order: Schema.Attribute.Relation<'manyToOne', 'api::order.order'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiOrderItemAddonOrderItemAddon
  ...
  attributes: {
    addon: Schema.Attribute.Relation<
      'manyToOne',
      'api::product-addon.product-addon'
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    extra_days: Schema.Attribute.Integer & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    >;
    price_extra: Schema.Attribute.Decimal & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiOrderItemOrderItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    addons: Schema.Attribute.Relation<
      'oneToMany',
      'api::order-item-addon.order-item-addon'
    >;
    addons_total_price: Schema.Attribute.Decimal &
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    delivery_days_base: Schema.Attribute.Integer & Schema.Attribute.Required;
    developer: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.user'
    >;
    ...
    platform_commission: Schema.Attribute.Decimal &
      Schema.Attribute.DefaultTo<0>;
    price_at_sale: Schema.Attribute.Decimal & Schema.Attribute.Required;
    product: Schema.Attribute.Relation<'manyToOne', 'api::product.product'>;
    product_title: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    quantity: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<1>;
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    client: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    client_confirmed: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    commission_breakdown: Schema.Attribute.JSON;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    developer_confirmed: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    developers_amount_total: Schema.Attribute.Decimal &
      Schema.Attribute.DefaultTo<0>;
    ...
    payment_status: Schema.Attribute.Enumeration<
      ['pending', 'platform_paid', 'developers_paid', 'all_paid']
    > &
      Schema.Attribute.DefaultTo<'pending'>;
    platform_commission_total: Schema.Attribute.Decimal &
      Schema.Attribute.DefaultTo<0>;
...
export interface ApiProductAddonProductAddon
  extends Struct.CollectionTypeSchema {
  collectionName: 'product_addons';
  info: {
    displayName: 'Product Addon';
  ...
  attributes: {
    ...
    extra_days: Schema.Attribute.Integer &
    ...
    price_extra: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    abilities: Schema.Attribute.Component<'product.abilities', true>;
    addons: Schema.Attribute.Relation<
      'oneToMany',
      'api::product-addon.product-addon'
    >;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    delivery_days_base: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
    ...
    included: Schema.Attribute.Component<'product.included', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::product.product'
    > &
      Schema.Attribute.Private;
    max_sales_count: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
    ...
    media_items: Schema.Attribute.Component<'product.media-item', true> &
      Schema.Attribute.SetMinMax<
        {
          max: 21;
          min: 2;
    ...
    price_base: Schema.Attribute.Decimal &
      ...
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    primaryCategory: Schema.Attribute.Relation<
      'manyToOne',
      'api::category.category'
    >;
    product_reviews: Schema.Attribute.Relation<
...
export interface ApiTransactionTransaction extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    order: Schema.Attribute.Relation<'manyToOne', 'api::order.order'>;
    payment_data: Schema.Attribute.JSON;
    payment_method: Schema.Attribute.Enumeration<
      ['unknown', 'bank_card', 'yoo_money', 'sbp', 'sberbank', 'cash']
    > &
      Schema.Attribute.DefaultTo<'unknown'>;
    platform_commission: Schema.Attribute.Decimal &
      Schema.Attribute.DefaultTo<0>;
    provider_payment_id: Schema.Attribute.String & Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
    status: Schema.Attribute.Enumeration<
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    buyer_chats: Schema.Attribute.Relation<'oneToMany', 'api::chat.chat'>;
    chat_messages: Schema.Attribute.Relation<
      'oneToMany',
      'api::chat-message.chat-message'
    >;
    ...
    role: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >;
    seller_chats: Schema.Attribute.Relation<'oneToMany', 'api::chat.chat'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    username: Schema.Attribute.String &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::developer-profile.developer-profile': ApiDeveloperProfileDeveloperProfile;
